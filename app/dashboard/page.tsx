                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            ...
                            <div className="bg-white rounded-lg p-5 shadow-sm">
                                ...
                                <div className="text-3xl font-semibold text-slate-800">24</div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg p-5 shadow-sm">
                                ...
                                <div className="text-3xl font-semibold text-slate-800">32</div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg p-5 shadow-sm">
                                ...
                                <div className="text-3xl font-semibold text-slate-800">12</div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg p-5 shadow-sm">
                                ...
                                <div className="text-3xl font-semibold text-slate-800">18</div>
                            </div>
                        </div>

                        {/* Recent Projects */}
                        <div>
                            <h2 className="text-2xl font-semibold text-slate-800 mb-4">Recent Projects</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {/* E-commerce Platform */}
                                <div className="bg-white rounded-lg p-5 shadow-sm">
                                    <div className="flex justify-between items-center mb-3">
                                        <h3 className="font-semibold text-slate-800">E-commerce Platform</h3>
                                        <span className="px-3 py-1 bg-green-100 text-green-600 text-xs font-medium rounded-full">Active</span>
                                    </div>
                                ...
                                <div className="bg-white rounded-lg p-5 shadow-sm">
                                    <div className="flex justify-between items-center mb-3">
                                        ...
                                        <span className="px-3 py-1 bg-red-100 text-red-600 text-xs font-medium rounded-full">In Review</span>
                                    </div>
                                ...
                                <div className="bg-white rounded-lg p-5 shadow-sm">
                                    <div className="flex justify-between items-center mb-3">
                                        ...
                                        <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded-full">Planning</span>
                                    </div>
